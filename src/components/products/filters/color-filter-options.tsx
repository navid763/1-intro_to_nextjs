...
export default function ColorFilterOptions({ colorHex, colorTitle, handler, selected }: IColorFilterOptions) {
    return (
        <div className="flex flex-col justify-center items-center p-1 gap-1 cursor-pointer" onClick={() => handler(colorHex)}>
